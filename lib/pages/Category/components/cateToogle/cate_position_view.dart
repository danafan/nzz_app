...
class CatePositionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() => Positioned(
                child: Offstage(
              offstage: cateToogleController.isOpen.value == false,
              child: Column(
                children: <Widget>[
                  Container(
                    height: 90.r,
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        GestureDetector(
                  onTap: () {
                    cateToogleController.changeOpenStatus(false);
                  },
                  child: Container(
                  ...
                  Container(
                    ...
                    child: MediaQuery.removePadding(
                        ...
                        child: Obx(() => GridView.builder(
                              ...
                              itemCount:
                                  categoryController.rightCateList.length,
