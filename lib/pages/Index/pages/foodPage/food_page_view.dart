...
import 'package:nzz/pages/Index/pages/foodPage/components/sort_model_widget.dart';
                    ...
                    slivers: <Widget>[
                      ...
                      SliverToBoxAdapter(
                        child: Container(
                            ...
                            padding:
                                EdgeInsets.fromLTRB(20.r, 10.r, 20.r, 20.r),
                            child: Column(
                              children: <Widget>[
                                // 轮播图
                                BannerListView(
                                    ...
                                    : SliverList(
                                        delegate: SliverChildBuilderDelegate(
                                          ...
                                          return FoodStoreItem(
                                            ...
                                            childCount: foodPageController
                                                .storeList.length //30个列表项
                                            ),
                                      ),
                          )),
                      // 列表加载状态
                      Obx(() => SliverToBoxAdapter(
                            ...
                            child:
                                LoadMoreView(foodPageController.isLoad.value),
                          )))
                    ],
                  ),
                ),
                // 排序弹窗
                Positioned(child:Obx(()=>Offstage(
                  offstage: foodPageController.openModel.value == false,
                  child:  SortModelWidget(),
                )))
              ],
            ),
          )
